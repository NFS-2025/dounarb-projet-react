                        ...
                        <div className="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`py-2.5 px-4 block w-full border rounded-lg sm:text-sm ${emailError ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                />
                                {emailError && (
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`py-2.5 px-4 block w-full border rounded-lg sm:text-sm ${passwordError ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                />
                                {passwordError && (
